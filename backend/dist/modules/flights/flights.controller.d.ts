...
export declare const bookFlightController: (req: Request, res: Response) => Promise<void>;
export declare const getBooking: (req: Request, res: Response) => Promise<void>;
export declare const cancelFlight: (req: Request, res: Response) => Promise<void>;
export declare const payForFlight: (req: Request, res: Response) => Promise<void>;
