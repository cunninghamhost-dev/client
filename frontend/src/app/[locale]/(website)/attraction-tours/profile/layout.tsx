...
const AttractionToursLayout = ({ children }: ILayoutProps) => {
  return (
    <section className='attractions-wrapper'>
      <div className='flex flex-col gap-8'>
              ...
              <div className='pb-0'>
                <div className='relative w-full flex flex-col justify-center items-center gap-2'>
                  ...
                  <div className='block space-y-0'>
                    <h1 className='font-bold text-5xl leading-normal text-white'>Unforgettable Adventures</h1>
                    <p className='font-bold text-2xl leading-[33.6px] text-white'>
                      Discover activities that makes every trip memorable
                    </p>
                  </div>
        ...
        <main className='mt-8 w-full max-w-[1070px] mx-auto px-4 sm:px-6 lg:px-8'>{children}</main>
      </div>
    </section>
  );
};

export default AttractionToursLayout;
