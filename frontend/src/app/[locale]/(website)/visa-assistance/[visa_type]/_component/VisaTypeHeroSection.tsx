...
import VisaTypeSubMenu from './VisaTypeSubMenu';
import { Card, CardContent } from '@/components/ui/card';
import VisaTypeFormField from './VisaTypeFormField';
//import SearchPanel from './SearchPanel';

const VisaTypeHeroSection = ({
  type,
  source,
  destination,
}: {
            ...
            <div className='pb-0'>
              <div className='w-full flex flex-col justify-center items-center gap-1'>
                ...
                <div className='relative w-full bg-transparent'>
                  <Card className='h-auto absolute top-[60px] left-1/2 transform -translate-x-1/2 -translate-y-[10%] w-full max-w-5xl bg-white rounded-lg backdrop-blur-md border-white/20 text-gray-700 pointer-events-auto hover:bg-white/98 transition-all cursor-default group'>
                    <CardContent>
                      <VisaTypeFormField type={type} source={source} destination={destination} />
                    </CardContent>
                  </Card>
                </div>
              </div>
...
export default VisaTypeHeroSection;
