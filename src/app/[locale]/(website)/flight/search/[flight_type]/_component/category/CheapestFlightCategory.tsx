        ...
        <CardContent>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex items-start justify-between w-full'>
              <div className='flex items-center justify-center gap-2 p-1 mt-1.5 bg-[#FFF6EC]'>
              ...
              <div className='flex gap-2 items-end justify-end'>
                <Button variant={'outline'} className=' cursor-pointer bg-[#F5F5F5] border-[#E0E0E0] hover:bg-gray-200'>
                  ...
                  <span className='hidden lg:inline font-semibold text-[#1A1A1A] text-xs leading-[18px]'>Save</span>
                </Button>
                <Button variant={'outline'} className=' cursor-pointer bg-[#F5F5F5] border-[#E0E0E0] hover:bg-gray-200'>
                  <SVGIcon fileName='icon-thick-right-arrow.svg' alt='Icon' width={13.6} height={12} />
                  <span className='hidden lg:inline font-semibold text-[#1A1A1A] text-xs leading-[18px]'>Share</span>
                </Button>
              </div>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-6 w-full'>
              <div className='lg:col-span-3 flex flex-col gap-8'>
                <div className='flex items-start gap-6 lg:gap-2'>
                  <div className='flex items-start gap-2'>
                    <Image
                      ...
                      priority
                    />
                    <div className='flex flex-col gap-2 text-xs lg:text-[13.78px] leading-[18px]'>
                  ...
                  <div className='flex-[1_1_auto] flex flex-col lg:flex-row items-end justify-end gap-2 lg:gap-4'>
                    <div className='block'>
                      <h4 className='font-bold text-[#0F294D] text-sm md:text-base lg:text-xl leading-normal md:leading-5'>
                        23:55
                      </h4>
                      <span className='font-normal text-[#8592A6] text-[11px] lg:text-[12.8px] leading-[18px]'>
                        LOS T1I
                      </span>
                    </div>
                    <div className='flex flex-col gap-1 items-end lg:item-center justify-end lg:justify-center'>
                      <h6 className='text-[#8592A6] text-[11.44px] leading-[18px]'>20h 2m</h6>
                      <div className='hidden relative lg:flex items-start gap-24 display-progress'>
                      ...
                      <h6 className='text-[#8592A6] text-[12px] leading-[18px] text-right lg:text-left'>
                        2 stops in Frankfurt., Airport
                      </h6>
                    </div>
                    <div className='block relative'>
                      <span className='absolute -top-3 -right-4 font-mono text-[#FF6F00] text-sm'>+1</span>
                      <h4 className='font-bold text-[#0F294D] text-base md:text-xl leading-normal md:leading-5'>
                        14:57
                      </h4>
              ...
              <div className='flex w-full h-auto justify-center items-center gap-2'>
                <div className='w-full flex flex-col gap-0 items-end justify-end'>
                  <Button variant={'outline'} className='hidden lg:block rounded-full p-4 text-xs font-bold'>
                    i
                  </Button>
                  <h2 className='font-bold text-[#1A1A1A] text-base md:text-xl leading-normal md:leading-[33.6px]'>
                    US$8,992
                  </h2>
                ...
                <div className=' relative'>
                  ...
                  <Button
                    variant={'outline'}
                    className='p-6 rounded-lg border border-[#E63A24] hover:bg-[#B02D1C] hover:text-white cursor-pointer'
                  >
                    Select
                  </Button>
                </div>
...
export default CheapestFlightCategory;
